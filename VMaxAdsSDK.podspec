Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/CloyMonisVMax/VMaxAdsSDK/archive/0.0.1.zip"}
  spec.ios.deployment_target = "12.0"
  spec.ios.vendored_frameworks = "VMaxAdsSDK-0.0.1/VMaxAdsSDK/VMaxAdsSDK.framework"
