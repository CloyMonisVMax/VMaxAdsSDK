Pod::Spec.new do |spec|
  ...
  #spec.source       = { :http => "https://github.com/CloyMonisVMax/VMaxAdsSDK/archive/0.0.51.zip"}
  spec.source       = { :git => "https://github.com/CloyMonisVMax/VMaxAdsSDK.git" , :tag => "0.0.51"}
  spec.ios.deployment_target = "12.0"
  #spec.ios.vendored_frameworks = "VMaxAdsSDK-0.0.51/VMaxAdsSDK/VMaxAdsSDK.framework"
