Pod::Spec.new do |spec|
  ...
  #spec.source       = { :http => "https://github.com/CloyMonisVMax/VMaxAdsSDK/archive/0.0.58.zip"}
  spec.source       = { :git => "https://github.com/CloyMonisVMax/VMaxAdsSDK.git" , :tag => "0.0.58"}
  spec.ios.deployment_target = "10.0"
  #spec.ios.vendored_frameworks = "VMaxAdsSDK-0.0.58/VMaxAdsSDK/VMaxAdsSDK.framework"
